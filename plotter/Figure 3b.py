...
with plt.rc_context({'text.usetex': False}):
    pdf = PdfPages(os.path.join(savedir,'Figure 3b.pdf'))
    for data in ['NASA','TJU','MIT','HUST', 'XJTU']:
        if data == 'XJTU':
            ...
            batches = ['Dataset_05_06_07_18', 'Dataset_25_26_27_28', 'Dataset_29_30_31_32', 'Dataset_33_34_36', 
                       'Dataset_38_39_40', 'Dataset_41_42_43_44', 'Dataset_45_46_47_48', 'Dataset_49_50_51_52', 
                       'Dataset_53_54_55_56']
        else:
            batches = None
        for batch in batches:
            if data in ['HUST','MIT']:
                root = f'../results/PINN/{data} results/Experiment1/'
